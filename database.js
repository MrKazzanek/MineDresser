const defaultSkins = [
    { id: "steve", name: "Steve", model: "steve", textureUrl: "https://minotar.net/skin/MHF_Steve", iconUrl: "https://minotar.net/helm/MHF_Steve/48.png" },
    { id: "alex", name: "Alex", model: "alex", textureUrl: "https://minotar.net/skin/Alex", iconUrl: "https://minotar.net/helm/Alex/48.png" },
    { id: "zuri", name: "Zuri", model: "alex", textureUrl: "https://minotar.net/skin/MHF_Zuri", iconUrl: "https://minotar.net/helm/MHF_Zuri/48.png" },
    { id: "sunny", name: "Sunny", model: "steve", textureUrl: "https://minotar.net/skin/MHF_Sunny", iconUrl: "https://minotar.net/helm/MHF_Sunny/48.png" },
    { id: "noor", name: "Noor", model: "alex", textureUrl: "https://minotar.net/skin/MHF_Noor", iconUrl: "https://minotar.net/helm/MHF_Noor/48.png" },
    { id: "makena", name: "Makena", model: "alex", textureUrl: "https://minotar.net/skin/MHF_Makena", iconUrl: "https://minotar.net/helm/MHF_Makena/48.png" },
    { id: "kai", name: "Kai", model: "steve", textureUrl: "https://minotar.net/skin/MHF_Kai", iconUrl: "https://minotar.net/helm/MHF_Kai/48.png" },
    { id: "efe", name: "Efe", model: "alex", textureUrl: "https://minotar.net/skin/MHF_Efe", iconUrl: "https://minotar.net/helm/MHF_Efe/48.png" },
    { id: "ari", name: "Ari", model: "alex", textureUrl: "https://minotar.net/skin/MHF_Ari", iconUrl: "https://minotar.net/helm/MHF_Ari/48.png" }
];
